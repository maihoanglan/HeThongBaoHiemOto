...
<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 "><b>CHỈNH SỬA KHÁCH HÀNG</b></h1>
				</div>
			</div>
			<!-- /.row -->
		</div>
	...
	<div class="content">
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-lg-6">
					<form:form action="${pageContext.request.contextPath}/updateKhachHang"
						...
						<button type="submit" class="btn btn-primary my-3 "
							onclick="submitKhachHang(event)">Chỉnh sửa</button>
					</form:form>
