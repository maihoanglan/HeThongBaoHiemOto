...
<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 "><b>THÊM MỚI HỢP ĐỒNG BẢO HIỂM</b></h1>
				</div>
			</div>
			<!-- /.row -->
		</div>
	...
	<div class="content">
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-lg-6">
					<form:form action="${pageContext.request.contextPath}/themHDBH"
						...
						<div class="form-group">
							...
							<c:if test="${messLoiMaKH != null}">
								<small class="text-danger"><c:out value="${messLoiMaKH}" /></small>
							</c:if>
						</div>
						...
						<div class="form-group">
							...
							<form:input path="giaTriHD" type="number" class="form-control"
								id="giaTriHD" />
							<small id="helpId" class="invalid-feedback"> Không đc để
								trống và phải lớn hơn 5.000.000 VND</small>
						</div>
						...
						<button type="submit" class="btn btn-primary my-3 "
							onclick="submitData(event)">Thêm Hợp Đồng</button>
					</form:form>
